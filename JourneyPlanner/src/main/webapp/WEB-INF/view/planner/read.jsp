		...
		<main  class="layout">
				...
				<section>
					...
					<form method="GET"  style="width:400px;">
						...
						<div class="m-3">
							<label for="">지역</label>
							<select class="form-select" name="areacode" disabled>
						...
						<div class="m-3">
							<select class="form-select" name="citycode" disabled>
								...
								<option value="11"<%=plannerDto.getCitycode()==11 ? "selected" : "" %>>전라북도</option>
						...
						<div class="m-3">
							<label for="">출발일</label>
							<input type="date" class="form-control" name="startdate" readonly value="<%=plannerDto.getStartdate()%>"/>
						</div>
						<div class="m-3">
							<label for="">종료일</label>
